...
# Cybersecurity Specialist focused on SOC & GRC | Threat Detection, Incident Response & Vulnerability Management | Hands-on with SIEM and XDR/EDR | MSc Electrical & Computer Engr. | CompTIA & ISC2 Certified
...
I am a Cybersecurity Specialist with hands-on experience in **SIEM alert investigation (Splunk, Microsoft Sentinel, Wazuh), detection engineering (KQL/SPL, dashboards, correlation rules), EDR/XDR analysis (Defender, SentinelOne, CrowdStrike), SOAR automation (Splunk SOAR, Sentinel Logic Apps), incident response (ticketing, case handling, playbooks, reporting), vulnerability management (Tenable, Rapid7, OpenVAS), threat intelligence, and GRC (risk registers, ISMS scope, policies, audit-ready artifacts). MSc in Electrical and Computer Engineering (University of Manitoba), CompTIA, ISC2 & Google Certified.
...
## About Chido Efobi, SOC & GRC Professional
...
I am particularly interested in Tier 2 SOC analyst roles and  GRC analyst roles where I can apply detection engineering, incident handling, and risk management to help organisations strengthen their security posture.
...
| Project                                                                       | Repository                                                                                                |
| ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| SOC Threat Hunt — Unauthorized TOR Usage (MDE)                                   | <a href="https://github.com/ChidoEfobi/SOC-Threat-Hunt">SOC threat Hunt</a>                   |
...
| Project                                                     | Repository                                                                                               |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| End-to-End Vulnerability Management Program Implementation  | <a href="">Vulnerability Management Program</a>   |
